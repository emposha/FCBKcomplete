...
a.append('<option value="'+c.val()+'" selected="selected" id="opt_'+b+'"class="selected">'+c.text()+"</option>")}});e.after(a);e.remove();e=a;d(e).bind("addItem",function(a,c){l(c.title,c.value,0,0,0)});d(e).bind("change",function(){b.onchange&&b.onchange.call(b.onchange)});d(e).bind("removeItem",function(a,c){var b=k.children("li[rel="+c.value+"]");b.length&&z(b)});d(e).bind("destroy",function(){k.remove();j.remove();e.show()});d(e).bind("selectAll",function(){var a=d(e).val()||[];d.each(d(e).data("cache"),
function(c,b){-1===d.inArray(c,a)&&l(b,c,0,0,0)});f.parent().hide()})}function l(a,h,c,f,g){if(!p())return!1;var j="bit-box"+(f?" locked":""),f=X(),l=document.createTextNode(b.show_values?n(h):n(a)),m=d('<a class="closebutton" href="#"></a>'),j=d('<li class="'+j+'" rel="'+h+'" id="pt_'+f+'"></li>').prepend(l).append(m);k.append(j);m.click(function(){z(d(this).parent("li"));return!1});c||(d("#"+o+"_annoninput").remove(),R(g),a=d('<option value="'+n(h,1)+'" id="opt_'+f+'" class="selected" selected="selected">'+
n(a)+"</option>"),e.append(a),b.onselect&&A(b.onselect,a),e.change());k.children("li.bit-box.deleted").removeClass("deleted");s(1);return f}function z(a){if(!a.hasClass("locked")){a.fadeOut("fast");var h=a.attr("id");if(b.onremove){var c=h?d("#o"+h+""):e.children("option[value="+a.attr("rel")+"]");A(b.onremove,c)}h?d("#o"+h+"").remove():e.children('option[value="'+a.attr("rel")+'"]').remove();a.remove();e.change();B=0}}function R(a){var h=d('<li class="bit-input" id="'+o+'_annoninput">'),c=d('<input type="text" class="maininput" size="'+
b.input_min_size+'" autocomplete="off">');0<b.input_tabindex&&c.attr("tabindex",b.input_tabindex);""!=b.input_name&&c.attr("name",b.input_name);k.append(h.append(c));c.focus(function(){C=!0;p()&&j.fadeIn("fast")});c.blur(function(){C=!1;D?j.fadeOut("fast"):c.focus()});k.click(function(){0>b.input_min_size&&f.length&&S(q(c.val(),1));c.focus();f.length&&c.val().length>b.input_min_size?f.show():(s(1),j.children(".default").show())});c.keypress(function(a){if(a.keyCode==r)return!1;a=b.input_min_size>
c.val().length?b.input_min_size:c.val().length+1;c.attr("size",a).width(parseInt(c.css("font-size"))*a)});c.keyup(function(a){var h=q(c.val(),1);if(a.keyCode==u&&0==h.length&&(s(1),!k.children("li.bit-box:last").hasClass("locked"))){if(0==k.children("li.bit-box.deleted").length)return k.children("li.bit-box:last").addClass("deleted"),!1;if(B)return;B=1;k.children("li.bit-box.deleted").fadeOut("fast",function(){z(d(this));return!1})}a.keyCode!=v&&a.keyCode!=w&&a.keyCode!=J&&a.keyCode!=K&&h.length>
b.input_min_size&&(S(h),j.children(".default").hide(),f.show())});b.oncreate&&A(b.oncreate,c);a&&setTimeout(function(){c.focus();j.children(".default").show()},1)}function E(a,h){f.html("");!b.cache&&null!=h&&m.clear();Y(a);null!=h&&h.length&&d.each(h,function(a,c){m.set(q(c.key),q(c.value))});var c=b.maxshownitems<m.length()?b.maxshownitems:m.length(),k="";d.each(m.search(a),function(h,d){if(c&&(!b.filter_selected||!e.children('option[value="'+d.key+'"]').hasClass("selected"))){var f=k,g='<li rel="'+
d.key+'">',j=d.value,l=b.filter_begin?"<em>$1</em>$2":"$1<em>$2</em>$3",m=(b.filter_begin?"":"(.*)")+(b.filter_case?"("+a+")(.*)":"("+a.toLowerCase()+")(.*)");try{j=j.replace(RegExp(m,b.filter_case?"g":"gi"),l)}catch(o){}k=f+(g+n(j)+"</li>");t++;c--}});f.append(k);b.firstselected&&(g=f.children("li:visible:first"),g.addClass("auto-focus"));t>b.height?f.css({height:24*b.height+"px",overflow:"auto"}):f.css("height","auto");p()&&j.is(":hidden")&&j.show()}function T(){f.children("li").mouseover(function(){f.children("li").removeClass("auto-focus");
g=d(this);g.addClass("auto-focus")});f.children("li").mouseout(function(){d(this).removeClass("auto-focus");g=null})}function Z(){f.unbind("mouseover").unbind("mouseout").mousemove(function(){T();f.unbind("mousemove")})}function F(){var a=d("#"+o+"_annoninput").children(".maininput");T();f.children("li").unbind("mousedown").mousedown(function(){var a=d(this);l(a.text(),a.attr("rel"),0,0,1);s(1);j.hide()});a.unbind("keydown");a.keydown(function(a){a.keyCode!=u&&k.children("li.bit-box.deleted").removeClass("deleted");
